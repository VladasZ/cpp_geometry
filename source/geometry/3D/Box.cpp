...
bool Box::intersects_ray(const Ray& ray) const {
    ...
    auto t1 = (min_bound.x - ray.begin.x) * ray.dirfrac().x;
    auto t2 = (max_bound.x - ray.begin.x) * ray.dirfrac().x;
    auto t3 = (min_bound.y - ray.begin.y) * ray.dirfrac().y;
    auto t4 = (max_bound.y - ray.begin.y) * ray.dirfrac().y;
    auto t5 = (min_bound.z - ray.begin.z) * ray.dirfrac().z;
    auto t6 = (max_bound.z - ray.begin.z) * ray.dirfrac().z;
